...
unsigned char ImprovedNoise::perm[] =
{
...
float  ImprovedNoise::Gradient( int hash, float x, float y , float z )
{
...
float ImprovedNoise::PeriodicNoise( float x, float y, float z, int px, int py, int pz )
{
    int ix0, iy0, ix1, iy1, iz0, iz1;
    float fx0, fy0, fz0, fx1, fy1, fz1;
    float s, t, r;
